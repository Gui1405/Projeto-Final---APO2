...
@WebServlet("/api/admin/limpeza")
public class LimpezaServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            for (Sala s : salas) {
                ...
                map.put("statusLimpeza", limpezaDAO.buscarUltimoStatus(s));
                result.add(map);
            }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            String acao = request.getParameter("acao"); // "iniciar" ou "finalizar"
            ...
            if ("iniciar".equals(acao)) {
                ...
                jsonResponse.put("message", "Limpeza iniciada. Sala bloqueada.");
            } else if ("finalizar".equals(acao)) {
                limpezaDAO.registrarFim(limpeza);
                jsonResponse.put("status", "success");
                jsonResponse.put("message", "Limpeza finalizada. Sala liberada.");
            } else {
                jsonResponse.put("status", "error");
